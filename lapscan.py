...
# LapScan is DEPRECATED
#
# The name lapscan is no long appropriate since the software will now be scanning desktop computers also.
# The executable has been renamed to lkm and no further development is intended for this file.

print "\n           *** lapscan.py has been renamed to lkm. Run lkm. ***\n"
exit(0)
